    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isMobileMenuOpen
            ? "bg-[#080808] border-b border-white/[0.08] py-3.5"
            : isScrolled
            ? "bg-onyx-950/95 backdrop-blur-md border-b border-white/[0.06] py-3.5"
      ...
      {/* Mobile Drawer Menu - Sibling to header so backdrop-filter never causes transparency bugs on iOS/scrolled states */}
      <div
        className={`fixed inset-0 z-40 flex flex-col justify-between px-7 pt-24 pb-10 transition-all duration-300 sm:hidden ${
          isMobileMenuOpen
